		...
		<div class="card card-dashboard-one">
			<div class="card-header border c-header-large">
				...
				<div class="pull-right">
					<!-- <a href="<?php echo site_url(); ?>farmasi/hutang/export_"><button type="button" class="btn btn-secondary btn-xs"><i class="fa fa-cloud-upload"></i> <span>Export</span> </button></a> -->
				</div>
			</div>
			<div class="card-body">
				<table class="table-bordered table-striped minimize-padding-all" id="dataHutang" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0">
					<thead>
						<tr role="row">
							<th>No.</th>
...
<div id="modal-manage-pembayaran-hutang" class="modal">
	<div class="modal-dialog" role="document">
		<form method="POST" name="form-manage-pembayaran-hutang">
			<div class="modal-content modal-content-demo">
				<div class="modal-header">
					<h6 class="modal-title">Pembayaran hutang</h6>
				...
				<div class="modal-body">
						...
						<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
							<div class="col-md-12">
								...
								<dl class="row mb-0">
									...
									<dd class="col-sm-1">:</dd>
									<dd class="col-sm-8 namaSupplier"></dd>
								</dl>
							</div>
						</section>
					</div>
					<div class="row">
						<section class="col-lg-12 col-md-12 col-sm-12 col-xs-12 border-top-dashed">
							<div class="col-sm-12">
								<dl class="row mb-0">
									<dt class="col-sm-3">Total Hutang</dt>
									<dd class="col-sm-1">:</dd>
				...
				<div class="modal-footer">
					<button type="submit" id="save-pembayaran-hutang" class="btn btn-primary"> <?= lang('label_save'); ?></button>
...
<div id="modal-detail" class="modal">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h6 class="modal-title">Detail Pembayaran Hutang</h6>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
