												...
												<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
													<div class="form-group">
														...
														<div class="d-grid gap-2 d-md-flex ">
															...
															<button type="button" class="btn btn-secondary btn-block btn-add btn-xs add-aturan-pakai "><i class="fa fa-plus"></i></button>
														</div>
													</div>
												</div>
												<div class="col-lg-2 col-md-2 col-sm-12 col-xs-12">
													<div class="form-group">
														...
														<div class="d-grid gap-2 d-md-flex ">
															...
															<button type="button" class="btn btn-secondary btn-block btn-add btn-xs add-cara-pakai "><i class="fa fa-plus"></i></button>
														</div>
													</div>
												</div>
												<div class="col-lg-1 col-md-1 col-sm-12 col-xs-12">
					...
					<div class="row">
						<section class="col-lg-12">
							<div class="card card-dashboard-one">
								...
								<div class="card-body" id="dataDaftarObat">
								</div>
							</div>
						</section>
					</div>
...
<div id="modal-manage-aturan-pakai" class="modal">
	<!-- modal satuan kategori-->
	<div class="modal-dialog" role="document">
		<form method="POST" name="form-manage-aturan-pakai">
			<div class="modal-content modal-content-demo">
				<div class="modal-header">
					...
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control input-sm" name="nama_aturan_pakai" autocomplete="off" placeholder="<?= lang('label_division'); ?>">
							</div>
						</div>
					</div>
				...
				<div class="modal-footer">
					<button type="submit" id="save-aturan-pakai" class="btn btn-indigo"><i class="fa fa-save"></i> <?= lang('label_save'); ?></button>
...
<div id="modal-manage-cara-pakai" class="modal">
	<!-- modal satuan kategori-->
	<div class="modal-dialog" role="document">
		<form method="POST" name="form-manage-cara-pakai">
			<div class="modal-content modal-content-demo">
				<div class="modal-header">
					<h6 class="modal-title">Add data</h6>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							<div class="form-group">
								<label class="form-label"><?= lang('label_division'); ?></label>
								<input type="text" class="form-control input-sm" name="nama_cara_pakai" autocomplete="off" placeholder="<?= lang('label_division'); ?>">
							</div>
						</div>
					</div>
					<input type="text" class="hide" name="_id" value="">
				...
				<div class="modal-footer">
					<button type="submit" id="save-cara-pakai" class="btn btn-indigo"><i class="fa fa-save"></i> <?= lang('label_save'); ?></button>
					<button type="button" class="btn btn-outline-light" data-dismiss="modal"><?= lang('label_close'); ?></button>
				</div>
			</div>
		</form>
											...
											<div class=" row">
												<div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
													<div class="form-group">
														...
														<input type="text" class="hide" name="id_pemeriksaan" value="">
