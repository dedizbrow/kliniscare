			...
			<div class="card-header bg-purple border-bottom bg-primary">
				...
				<?php if (!empty($list_pemeriksaan)) { ?>
					<div class="btn-group pull-right">
						<a href="<?= base_url(conf('path_module_lab') . 'report/biaya-pemeriksaan/export/excel?start_date=' . $start_date . '&end_date=' . $end_date . '&provider=' . $provider . '&jenis=' . $jenis . '&pdf=true'); ?>" target="_blank" download class="btn btn-xs bg-white"><i class="fa fa-file-excel-o tx-success"></i> Download Excel</a>
						<a href="<?= base_url(conf('path_module_lab') . 'report/biaya-pemeriksaan/export?start_date=' . $start_date . '&end_date=' . $end_date . '&provider=' . $provider . '&jenis=' . $jenis . '&pdf=true'); ?>" target="_blank" download class="btn btn-xs bg-white"><i class="fa fa-file-pdf-o tx-danger"></i> Download PDF</a>
					</div>
				<?php } ?>
			</div>
