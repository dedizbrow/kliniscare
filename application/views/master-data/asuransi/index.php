		...
		<div class="card card-dashboard-one">
			<div class="card-header border c-header">
				<div class="card-title">
					...
					if (isset($import_id)) {
						echo "<input type='hidden' id='import_id' value='" . $import_id . "'><br>
							...
							<a class='text-normal tx-danger' href='" . base_url('asuransi') . "' title='Click disini untuk kembali ke keseluruhan data asuransi'><sup><i class=''></i> clear filter</sup></a>
							</div>
				...
				<div class="pull-right">
					<?php if (isAllowed('c-asuransi^create', true)) { ?>
						<button type="button" class="btn btn-success add-asuransi btn-xs"><i class="fa fa-plus"></i> Tambah Data</button>
						<button type="button" class="btn btn-import import__ btn-xs"><i class="fa fa-cloud-upload"></i> <span>Import</span> </button>
					<?php } ?>
					<a href="<?php echo site_url(); ?>master-data/asuransi/export_"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-cloud-upload"></i> <span>Export</span> </button></a>
				</div>
			</div>
			<div class="card-body">
				<table class="table table-bordered table-striped minimize-padding-all" id="dataAsuransi" role="grid" aria-describedby="dataTable_info" style="width: 100%;" width="100%" cellspacing="0">
					<thead>
						<tr role="row">
							<th>No .</th>
							<th class="search" data-name="namaAsuransi"><?= lang('label_name'); ?></th>
...
<div id="modal-manage-asuransi" class="modal">
	<div class="modal-dialog" role="document">
		<form method="POST" name="form-manage-asuransi">
			<div class="modal-content modal-content-demo">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control input-sm" name="namaAsuransi" id="namaAsuransi" autocomplete="off" placeholder="<?= lang('label_enter_name'); ?>">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
								<label class="form-label"><?= lang('label_telp_number'); ?></label>
								<input type="text" class="form-control input-sm" name="telp" id="telp" autocomplete="off" placeholder="<?= lang('label_enter_telp_number'); ?>">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control input-sm" name="email" autocomplete="off" id="email" placeholder="<?= lang('label_enter_email'); ?>">
							</div>
						</div>
					</div>
					<div class="row">
				...
				<div class="modal-footer">
					<button type="submit" id="save-asuransi" class="btn btn-primary"> <?= lang('label_save'); ?></button>
				...
				<div class="modal-body">
					<div class="card card-body bg-primary tx-white bd-0">
						...
						<ul class="m-0 pl-3">
							...
							<li>Format urutan kolom harus disesuaikan dengan sample yang ada. Jika belum ada silahkan download <a href="<?= base_url('files/docs/M_FormatImportDataAsuransi.xlsx'); ?>" class="tx-warning" target="_blank">disini</a></li>
						</ul>
						</p>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<img src="<?= base_url('assets/img/image-sample-import-asuransi.png'); ?>" class="zoomImage" style="max-width: 100%;border: 1px solid #ff0000">
						</div>
					</div>
					<div class="row">
						<hr>
