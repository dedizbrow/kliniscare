		...
		<div class="card card-dashboard-one">
			<div class="card-header border c-header">
				<div class="card-title">
					...
					if (isset($import_id)) {
						echo "<input type='hidden' id='import_id' value='" . $import_id . "'><br>
							...
							<a class='text-normal tx-danger' href='" . base_url('supplier') . "' title='Click disini untuk kembali ke keseluruhan data supplier'><sup><i class=''></i> clear filter</sup></a>
							</div>
				...
				<div class="pull-right">
					<?php if (isAllowed('c-supplier^create', true)) { ?>
						<button type="button" class="btn btn-success add-supplier btn-xs"><i class="fa fa-plus"></i> Tambah Data</button>
						<button type="button" class="btn btn-import import__ btn-xs"><i class="fa fa-cloud-upload"></i> <span>Import</span> </button>
					<?php } ?>
					<a href="<?php echo site_url(); ?>master-data/supplier/export_"><button type="button" class="btn btn-warning btn-xs"><i class="fa fa-cloud-upload"></i> <span>Export</span> </button></a>
				</div>
			</div>
			<div class="card-body">
				<table class="table table-bordered table-striped minimize-padding-all" id="dataSupplier" role="grid" aria-describedby="dataTable_info" cellspacing="0">
					<thead>
						<tr role="row">
							<th>No.</th>
							<th><?= lang('label_supplier_code'); ?></th>
...
<div id="modal-manage-supplier" class="modal">
	<div class="modal-dialog" role="document">
		<form method="POST" name="form-manage-supplier">
			<div class="modal-content modal-content-demo">
					...
					<div class="row">
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
								<label class="form-label"><?= lang('label_supplier_code'); ?></label>
								<input type="text" class="form-control input-sm" name="kodeSupplier" id="kodeSupplier" autocomplete="off" placeholder="<?= lang('label_enter_supplier_code'); ?>">
							</div>
						</div>
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="form-group">
								<label class="form-label"><?= lang('label_name'); ?></label>
								<input type="text" class="form-control input-sm" name="namaSupplier" id="namaSupplier" autocomplete="off" placeholder="<?= lang('label_enter_name'); ?>">
							</div>
						</div>
					</div>
					<div class="row">
						...
						<div class="col-lg-12 col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="text" class="form-control input-sm" name="notelp" id="notelp" autocomplete="off" placeholder="<?= lang('label_enter_telp_number'); ?>">
							</div>
						</div>
				...
				<div class="modal-footer">
					<button type="submit" id="save-supplier" class="btn btn-primary"><?= lang('label_save'); ?></button>
				...
				<div class="modal-body">
					<div class="card card-body bg-primary tx-white bd-0">
						...
						<ul class="m-0 pl-3">
							...
							<li>Format urutan kolom harus disesuaikan dengan sample yang ada. Jika belum ada silahkan download <a href="<?= base_url('files/docs/M_FormatImportDataSupplier.xlsx'); ?>" class="tx-warning" target="_blank">disini</a></li>
						</ul>
						</p>
					</div>
					<div class="row">
						<div class="col-lg-12 col-md-12 col-sm-12">
							...
							<img src="<?= base_url('assets/img/image-sample-import-supplier.png'); ?>" class="zoomImage" style="max-width: 100%;border: 1px solid #ff0000">
						</div>
					</div>
					<div class="row">
						<hr>
