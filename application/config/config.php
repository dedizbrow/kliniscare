...
$server_ip=explode(".",$ip_server);
if(in_array('localhost',$server_ip) || in_array('127',$server_ip) || in_array('::1',$server_ip)){
	$base_server="127.0.0.1"; // server local development
}else{
	array_pop($server_ip);
	$subnet_ip=implode(".",$server_ip);
	$base_server=$ip_server; // server vps
}
$config['base_server']=$base_server;
// $base_server="localhost";// jangan letakkan http didepan. cukup localhost atau IP addressnya
$config['base_url'] = ($base_server=="127.0.0.1") ? "http://$base_server/kliniscare/" : "http://$base_server/"; 
// Jika setting diatas tidak otomatis jalan, enable kan setting dibawah ini ketika di VPS
// $base_server="134.209.109.240";
// $config['base_url'] = "http://$base_server/"; 
...
/*
| Super Admin User Code
*/
$config['super_admin_code'] = "c-spadmin";
$config['super_admin_id'] = "admin@codewell.co.id";
/*
|--------------------------------------------------------------------------
